...
export const getDailySummary = (start, end) =>
  API.get(`/summary/daily?start=${start}&end=${end}`);
...
// Security Logs
export const getSecurityLogs = (piiDetected) =>
  API.get("/security/logs", { params: { pii_detected: piiDetected } });
